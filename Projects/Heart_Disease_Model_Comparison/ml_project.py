# using heart attack csv for final project where i will be comparing multiple models and see
# which one gives the highest accuracy while predicting heart attack
import numpy as np
import pandas as pd
...
#  creating and evaluating models one by one will be tedious task
#  i will create all models in one go
...
result = []  # empty list to store result of models
...
# 0  Logistic_Regression    0.8696    0.8857
# 1                  KNN    0.8641    0.8815
# 2          Naive_Bayes    0.8533    0.8683
# 3        Decision_Tree    0.7826    0.8039
# 4                  SVM    0.8478    0.8679

# now i will save this model in order to use it in some front end
# model is saved in pickle format using pickle module
# import joblib module

# joblib.dump(models['KNN'], 'KNN_Model_heart_attack_prediction.pkl')
