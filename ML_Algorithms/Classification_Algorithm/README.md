...
This folder covers classification — problems where the answer is a category, not a number. Each algorithm gets its own subfolder with code, notes, and results.
...
_Each subfolder has its own README, NOTES and Python file._
